...
Partial Public Class DataSet2
    ...
    Partial Public Class STAFFDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddSTAFFRow(ByVal ID As Decimal, ByVal FIRSTNAME As String, ByVal LASTNAME As String, ByVal ADDRESS As String, ByVal CONTACTNUM As Decimal, ByVal ROLE As String, ByVal EMAIL As String, ByVal PASSWORD As String) As STAFFRow
            Dim rowSTAFFRow As STAFFRow = CType(Me.NewRow,STAFFRow)
            Dim columnValuesArray() As Object = New Object() {ID, FIRSTNAME, LASTNAME, ADDRESS, CONTACTNUM, ROLE, EMAIL, PASSWORD}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function FindByID(ByVal ID As Decimal) As STAFFRow
        ...
        Private Sub InitClass()
            ...
            Me.columnCONTACTNUM = New Global.System.Data.DataColumn("CONTACTNUM", GetType(Decimal), Nothing, Global.System.Data.MappingType.Element)
    ...
    Partial Public Class STAFFRow
        ...
        Public Property ID() As Decimal
            Get
                Return CType(Me(Me.tableSTAFF.IDColumn),Decimal)
            End Get
            Set
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Property CONTACTNUM() As Decimal
            Get
                Return CType(Me(Me.tableSTAFF.CONTACTNUMColumn),Decimal)
            End Get
            Set
                Me(Me.tableSTAFF.CONTACTNUMColumn) = value
            End Set
        End Property
...
Namespace DataSet2TableAdapters
    ...
    Partial Public Class STAFFTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM ""SEPROJ"".""STAFF"" WHERE ((""ID"" = :Original_ID) AND (""FIRSTNAME"" = :Ori"& _ 
                "ginal_FIRSTNAME) AND (""LASTNAME"" = :Original_LASTNAME) AND (""ADDRESS"" = :Origina"& _ 
                "l_ADDRESS) AND (""CONTACTNUM"" = :Original_CONTACTNUM) AND (""ROLE"" = :Original_ROL"& _ 
                "E) AND (""EMAIL"" = :Original_EMAIL) AND (""PASSWORD"" = :Original_PASSWORD))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("Original_FIRSTNAME", Global.System.Data.OracleClient.OracleType.VarChar, 0, Global.System.Data.ParameterDirection.Input, "FIRSTNAME", Global.System.Data.DataRowVersion.Original, false, Nothing))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("Original_LASTNAME", Global.System.Data.OracleClient.OracleType.VarChar, 0, Global.System.Data.ParameterDirection.Input, "LASTNAME", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("Original_CONTACTNUM", Global.System.Data.OracleClient.OracleType.Number, 0, Global.System.Data.ParameterDirection.Input, "CONTACTNUM", Global.System.Data.DataRowVersion.Original, false, Nothing))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("Original_ROLE", Global.System.Data.OracleClient.OracleType.VarChar, 0, Global.System.Data.ParameterDirection.Input, "ROLE", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO ""SEPROJ"".""STAFF"" (""ID"", ""FIRSTNAME"", ""LASTNAME"", ""ADDRESS"", ""CONTACTN"& _ 
                "UM"", ""ROLE"", ""EMAIL"", ""PASSWORD"") VALUES (:ID, :FIRSTNAME, :LASTNAME, :ADDRESS, "& _ 
                ":CONTACTNUM, :ROLE, :EMAIL, :PASSWORD)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("FIRSTNAME", Global.System.Data.OracleClient.OracleType.VarChar, 0, Global.System.Data.ParameterDirection.Input, "FIRSTNAME", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("LASTNAME", Global.System.Data.OracleClient.OracleType.VarChar, 0, Global.System.Data.ParameterDirection.Input, "LASTNAME", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("CONTACTNUM", Global.System.Data.OracleClient.OracleType.Number, 0, Global.System.Data.ParameterDirection.Input, "CONTACTNUM", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("ROLE", Global.System.Data.OracleClient.OracleType.VarChar, 0, Global.System.Data.ParameterDirection.Input, "ROLE", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE ""SEPROJ"".""STAFF"" SET ""ID"" = :ID, ""FIRSTNAME"" = :FIRSTNAME, ""LASTNAME"" = :L"& _ 
                "ASTNAME, ""ADDRESS"" = :ADDRESS, ""CONTACTNUM"" = :CONTACTNUM, ""ROLE"" = :ROLE, ""EMAI"& _ 
                "L"" = :EMAIL, ""PASSWORD"" = :PASSWORD WHERE ((""ID"" = :Original_ID) AND (""FIRSTNAME"& _ 
                """ = :Original_FIRSTNAME) AND (""LASTNAME"" = :Original_LASTNAME) AND (""ADDRESS"" = "& _ 
                ":Original_ADDRESS) AND (""CONTACTNUM"" = :Original_CONTACTNUM) AND (""ROLE"" = :Orig"& _ 
                "inal_ROLE) AND (""EMAIL"" = :Original_EMAIL) AND (""PASSWORD"" = :Original_PASSWORD)"& _ 
                ")"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("FIRSTNAME", Global.System.Data.OracleClient.OracleType.VarChar, 0, Global.System.Data.ParameterDirection.Input, "FIRSTNAME", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("LASTNAME", Global.System.Data.OracleClient.OracleType.VarChar, 0, Global.System.Data.ParameterDirection.Input, "LASTNAME", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("CONTACTNUM", Global.System.Data.OracleClient.OracleType.Number, 0, Global.System.Data.ParameterDirection.Input, "CONTACTNUM", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("ROLE", Global.System.Data.OracleClient.OracleType.VarChar, 0, Global.System.Data.ParameterDirection.Input, "ROLE", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("Original_FIRSTNAME", Global.System.Data.OracleClient.OracleType.VarChar, 0, Global.System.Data.ParameterDirection.Input, "FIRSTNAME", Global.System.Data.DataRowVersion.Original, false, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("Original_LASTNAME", Global.System.Data.OracleClient.OracleType.VarChar, 0, Global.System.Data.ParameterDirection.Input, "LASTNAME", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("Original_CONTACTNUM", Global.System.Data.OracleClient.OracleType.Number, 0, Global.System.Data.ParameterDirection.Input, "CONTACTNUM", Global.System.Data.DataRowVersion.Original, false, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("Original_ROLE", Global.System.Data.OracleClient.OracleType.VarChar, 0, Global.System.Data.ParameterDirection.Input, "ROLE", Global.System.Data.DataRowVersion.Original, false, Nothing))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, FIRSTNAME, LASTNAME, ADDRESS, CONTACTNUM, ""ROLE"", EMAIL, ""PASSWORD"" FR"& _ 
                "OM SEPROJ.STAFF"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Decimal, ByVal Original_FIRSTNAME As String, ByVal Original_LASTNAME As String, ByVal Original_ADDRESS As String, ByVal Original_CONTACTNUM As Decimal, ByVal Original_ROLE As String, ByVal Original_EMAIL As String, ByVal Original_PASSWORD As String) As Integer
            ...
            End If
            Me.Adapter.DeleteCommand.Parameters(4).Value = CType(Original_CONTACTNUM,Decimal)
        ...
        Public Overloads Overridable Function Insert(ByVal ID As Decimal, ByVal FIRSTNAME As String, ByVal LASTNAME As String, ByVal ADDRESS As String, ByVal CONTACTNUM As Decimal, ByVal ROLE As String, ByVal EMAIL As String, ByVal PASSWORD As String) As Integer
            ...
            End If
            Me.Adapter.InsertCommand.Parameters(4).Value = CType(CONTACTNUM,Decimal)
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_CONTACTNUM As Decimal,  _
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(4).Value = CType(CONTACTNUM,Decimal)
            If (ROLE Is Nothing) Then
                Throw New Global.System.ArgumentNullException("ROLE")
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_CONTACTNUM,Decimal)
            If (Original_ROLE Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_ROLE")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal FIRSTNAME As String, ByVal LASTNAME As String, ByVal ADDRESS As String, ByVal CONTACTNUM As Decimal, ByVal ROLE As String, ByVal EMAIL As String, ByVal PASSWORD As String, ByVal Original_ID As Decimal, ByVal Original_FIRSTNAME As String, ByVal Original_LASTNAME As String, ByVal Original_ADDRESS As String, ByVal Original_CONTACTNUM As Decimal, ByVal Original_ROLE As String, ByVal Original_EMAIL As String, ByVal Original_PASSWORD As String) As Integer
            Return Me.Update(Original_ID, FIRSTNAME, LASTNAME, ADDRESS, CONTACTNUM, ROLE, EMAIL, PASSWORD, Original_ID, Original_FIRSTNAME, Original_LASTNAME, Original_ADDRESS, Original_CONTACTNUM, Original_ROLE, Original_EMAIL, Original_PASSWORD)
        End Function
    End Class
        ...
        Public Overridable Function UpdateAll(ByVal dataSet As DataSet2) As Integer
            ...
            Try 
                ...
                If (Not (Me._sTAFFTableAdapter) Is Nothing) Then
                    ...
                    Me._sTAFFTableAdapter.Connection = CType(workConnection,Global.System.Data.OracleClient.OracleConnection)
                    Me._sTAFFTableAdapter.Transaction = CType(workTransaction,Global.System.Data.OracleClient.OracleTransaction)
            ...
            Finally
                ...
                End If
                If (Not (Me._sTAFFTableAdapter) Is Nothing) Then
                    Me._sTAFFTableAdapter.Connection = CType(revertConnections(Me._sTAFFTableAdapter),Global.System.Data.OracleClient.OracleConnection)
