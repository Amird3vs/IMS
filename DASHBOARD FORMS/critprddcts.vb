<Obsolete>
Public Class critprddcts

    Private Sub critprddcts_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadInGridview()
        ...
        cn.Open()
        Dim command As New OracleClient.OracleCommand("Select PRODUCT_CODE, DESCTIPTION AS DESCRIPTION, REORDER, QUANTITY FROM PRDCTS WHERE REORDER >= QUANTITY", cn)
