<Obsolete>
Public Class MnthlySalesFrm
    Private Sub MnthlySalesFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadInGridview()
        ...
        cn.Open()
        Dim command As New OracleClient.OracleCommand("Select INVOICE_NO, PRODUCT_CODE, DSCRTN AS DESCRIPTION, CATEGORY, PRICE, QUANTITY, TOTAL, USERS, STATUS, SOLD_DATE FROM TBLCART WHERE SOLD_DATE BETWEEN trunc(sysdate-30) AND trunc(sysdate)", cn)
